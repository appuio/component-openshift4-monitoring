...
test_instances = tests/capacity-alerts.yml tests/remote-write.yml tests/user-workload-monitoring.yml tests/capacity-alerts-with-node-labels.yml tests/vsphere.yml tests/custom-rules.yml tests/team-routing.yml tests/ovn-kubernetes.yml tests/release-4.16.yml tests/release-4.17.yml
